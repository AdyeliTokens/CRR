...
{
    public class VisualDataMap : EntityTypeConfiguration<VisualData>
    {
        public VisualDataMap()
        {
            #region Properties
            ToTable("CRR_VisualData");
            HasKey(c => c.Id);
            ...
            #region HasRequired
            this.HasRequired(x => x.WorkCenter).WithMany(y => y.VisualData).HasForeignKey(x => x.IdWorkCenter);
            #endregion
